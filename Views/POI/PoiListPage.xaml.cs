...
public partial class PoiListPage : ContentPage
{
  ...
  LoadLanguage();
    ...
    {
        if (TitleLabel != null)
          TitleLabel.Text = AppResources.GetString("PoiListTitle");
            
        SearchEntry.Placeholder = AppResources.GetString("SearchPlaceholder");
        SubtitleLabel.Text = AppResources.GetString("ExploreSubtitle");
        AllCategoryLabel.Text = AppResources.GetString("AllCategories");
    RestaurantLabel.Text = AppResources.GetString("Restaurant");
        LocationLabel.Text = AppResources.GetString("Location");
      HistoryLabel.Text = AppResources.GetString("History");
        
      Debug.WriteLine($"[PoiListPage] 🌐 UI loaded in language: {AppResources.GetCurrentLanguage()}");
 }
